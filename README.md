# OpenScan Mobile — design artifacts

Importable sticker-sheet for **`androidx.compose.material3:material3`**, rendered from the committed
`@Preview` catalog in [`yschimke/openscan-android`](https://github.com/yschimke/openscan-android). This branch is a
**generated delivery artifact** — browse it in the page below, or pull it into
Figma / Stitch / Claude Design.

## 🔎 Browse the catalog

**[▶ Open the rendered catalog (htmlpreview)](https://htmlpreview.github.io/?https://github.com/yschimke/openscan-android/blob/design-artifacts/openscan-android/index.html)**
...
**[▶ Open the PNG↔SVG comparison (htmlpreview)](https://htmlpreview.github.io/?https://github.com/yschimke/openscan-android/blob/design-artifacts/openscan-android/compare.html)**
...
**[▶ Open this catalog in the live preview server](https://preview.coo.ee/openscan-android/)**

The same rendered components, served live by `compose-preview serve --catalogs openscan-android` —
...
| --- | --- |
| Components | **8** |
| Rendered images (PNG) | **8** |
| Editable wireframes (SVG) | **8** |
| Editable design vectors (figma-svg) | **8** |
| Components with a11y greenlines | **4** |
| Library | `androidx.compose.material3:material3`<br>`ee.schimke.openscan:openscan-components (OpenScanTheme)` |
| Renderer | compose-preview 0.16.39 |
...
| Foundation | 2 |
| Scanners | 2 |
| Screens · Scanner list | 2 |
| Screens · Scanner detail | 2 |

## What's in this branch

| Path | What it is |
| --- | --- |
| `index.html` | Self-contained gallery — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/yschimke/openscan-android/blob/design-artifacts/openscan-android/index.html) |
| `compare.html` | PNG↔SVG comparison with a live structural-similarity score — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/yschimke/openscan-android/blob/design-artifacts/openscan-android/compare.html) |
...
- **Customise** — open the [live preview server](https://preview.coo.ee/openscan-android/) (or any image's `livePreview` link in `catalog.json`) to re-render a component under different themes / locales / devices.
...
Generated by the [`Design Artifacts`](https://github.com/yschimke/openscan-android/actions/workflows/design-artifacts.yml)
